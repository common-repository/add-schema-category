...
function ATH_SCHEMA()
{
	...
	echo wp_kses($get_peymanseo_schema_category, array('script' => array("type" => array())));
}
...
if (!class_exists('WooCommerce')) {
	...
	add_action('woocommerce_archive_description', function ($content) {
		...
		if (is_product_category())
			echo wp_kses(get_term_meta(get_queried_object_id(), 'peymanseo_schema_category', true), array('script' => array("type" => array())));
	});
}
